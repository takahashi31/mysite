...
def warning_stocks(name, url, kospi) :
	...
	if prices != [] :
		...
		#fname = '..\\Data\\KOSPI\\' + name + '_list.txt'
		fname = PATH_DATA + 'list_' + name
		save_to_file_json(fname, prices)

		#fname = name + '_list.csv'
		#fname = '..\\Data\\KOSPI\\' + name + '_list.csv'
		fname = PATH_DATA + 'list_'  + name
...
def load_codes(market) :
	...
	#fname = '..\\Data\\KOSPI\\' + market + '_codes.txt'
	fname = PATH_DATA + market + '_codes.txt'
...
if 1 :
	...
	#fname = 'warning1'
	url = 'https://finance.naver.com/sise/trading_halt.naver?sosok=0'
	#fname = 'trading_halt_' + int_date
	fname = 'trading_halt'
	#warning_stocks(fname, url, kospi_codes, kosdaq_codes)
	warning_stocks(fname, url, kospi_codes)

	# 관리종목
	#url = 'https://finance.naver.com/sise/management.nhn'
	#fname = 'warning2'
	url = 'https://finance.naver.com/sise/management.naver?sosok=0'
	#fname = 'management_' + int_date
	fname = 'management'
	#warning_stocks(fname, url, kospi_codes, kosdaq_codes)
	warning_stocks(fname, url, kospi_codes)
